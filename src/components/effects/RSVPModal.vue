...
<template>
  <Teleport to="body">
    <Transition enter-active-class="transition duration-300" enter-from-class="opacity-0" leave-active-class="transition duration-150" leave-to-class="opacity-0">
      <div v-if="isHome && show && isLoggedIn && !alreadyAnswered" class="fixed inset-0 z-[210] flex items-center justify-center p-4">
        ...
        <div class="relative w-full max-w-md bg-bg-primary border border-emerald-500/40 shadow-2xl p-6">
          <div class="text-center mb-5">
            ...
            <p class="text-sm text-text-secondary leading-relaxed">
              the hackathon at <strong class="text-text-primary">[VENUE], [CITY]</strong> on <strong class="text-text-primary">[EVENT_DATES]</strong>. Please confirm so we can finalize seating and logistics.
            </p>
          </div>
