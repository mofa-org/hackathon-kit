    ...
    <div class="relative max-w-4xl mx-auto px-6">
      ...
      <div class="reveal reveal-delay-1">
        ...
        <div class="space-y-6 text-text-secondary text-base leading-relaxed">
          <p>
            <!-- TODO: Replace with your parent event URL -->
            {{ t('about.partOf') }} <a href="#" target="_blank" class="text-text-primary font-semibold hover:text-accent-blue transition-colors">{{ t('about.partOfEvent') }}</a>{{ t('about.partOfSuffix') }}
          </p>
